/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7bf5d32e743455ec1859fccb17326542)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ENVIRONMENT: "mock" | "production";
	ENABLE_BANKING_BASE_URL: "https://example.invalid/enable-banking" | "https://api.enablebanking.com";
	LUNCH_MONEY_BASE_URL: "https://mock.lunchmoney.dev/v2" | "https://api.lunchmoney.dev/v2";
	BANK_NAME: "Fortuneo";
	BANK_COUNTRY: "FR";
	CALLBACK_URL: "http://localhost:8787/callback" | "https://replace-with-your-worker-hostname.example/callback";
	DATA_PROTECTION_EMAIL: "operator@example.com";
	WEB_PUSH_VAPID_PUBLIC_KEY: "REPLACE_WITH_YOUR_VAPID_PUBLIC_KEY";
	WEB_PUSH_VAPID_SUBJECT: "mailto:operator@example.com";
	SYNC_ENABLED: "false";
	SYNC_WORKFLOW: Workflow<Parameters<import("./src/index").DailySyncWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface MockEnv {
		DB: D1Database;
		ENVIRONMENT: "mock";
		ENABLE_BANKING_BASE_URL: "https://example.invalid/enable-banking";
		LUNCH_MONEY_BASE_URL: "https://mock.lunchmoney.dev/v2";
		BANK_NAME: "Fortuneo";
		BANK_COUNTRY: "FR";
	...
	interface ProductionEnv {
		...
		LUNCH_MONEY_BASE_URL: "https://api.lunchmoney.dev/v2";
		BANK_NAME: "Fortuneo";
		BANK_COUNTRY: "FR";
		CALLBACK_URL: "https://replace-with-your-worker-hostname.example/callback";
		DATA_PROTECTION_EMAIL: "operator@example.com";
		WEB_PUSH_VAPID_PUBLIC_KEY: "REPLACE_WITH_YOUR_VAPID_PUBLIC_KEY";
		WEB_PUSH_VAPID_SUBJECT: "mailto:operator@example.com";
		SYNC_ENABLED: "false";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ENABLE_BANKING_BASE_URL" | "LUNCH_MONEY_BASE_URL" | "BANK_NAME" | "BANK_COUNTRY" | "CALLBACK_URL" | "DATA_PROTECTION_EMAIL" | "WEB_PUSH_VAPID_PUBLIC_KEY" | "WEB_PUSH_VAPID_SUBJECT" | "SYNC_ENABLED">> {}
}
